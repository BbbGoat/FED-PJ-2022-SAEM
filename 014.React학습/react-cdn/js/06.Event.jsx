...
function EventShow() {
    ...
    // 1. 소원이 무엇이냐 실행 함수 //////
    const aladin = (imgsrc) => { // imgsrc - 알라딘 주인공 이미지 경로!
        console.log("aladin함수:",imgsrc);
        ...
        ReactDOM.render(<AlaLamp isrc={imgsrc} />,document.querySelector("#ala"));
    ...
    return (
        <React.Fragment>
            ...
            <button onClick={()=>{getIt2('https://www.pngplay.com/wp-content/uploads/13/Ferrari-458-Transparent-PNG.png');}}>소원빌기~!!! 페라리주세요~!!!</button>
        </React.Fragment>
    );
