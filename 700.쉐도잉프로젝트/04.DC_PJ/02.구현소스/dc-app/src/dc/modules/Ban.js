...
function Ban(props) { 
    ...
    const goSlide = (e) => {
        ...
        // console.log(ele);
            ...
            if (isB) {
                tg.animate({left:"-100%"}, 400, function(){ // this는 타겟!
                    // 첫번째 li 맨 뒤로 보내기! 동시에 left: 0
            ...
            $(ele).siblings(".indic").find("li").eq(tg.find("li").eq(isB).attr("data-seq"))
